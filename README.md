...
### **🌎 Contributing: Multilingual Support**

TitleClip supports **English and Spanish**, with automatic detection based on the system language.

Would you like to contribute with translations?

1. Check the `src/data/translations.json` file to see the current structure.
2. Add your language following the same format.
3. Submit a pull request on GitHub!

We appreciate all contributions that help make TitleClip more accessible worldwide.

---

### **🔍 Future Considerations**

At this stage, TitleClip is fully functional and optimized for its core purpose.  
However, we are open to suggestions from the community regarding potential improvements, provided they align with the lightweight nature of the plugin.

If you have an idea that enhances usability without overcomplicating the workflow, feel free to open an issue on GitHub!
